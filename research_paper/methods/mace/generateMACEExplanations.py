...
from research_paper.methods.mace.modelConversion import *
...
def genExp(
  ...
  norm_type,
  epsilon,
  threshold=None, target=1):

  start_time = time.time()

  log_file = explanation_file #open(explanation_file_name,'w')
  ...
  factual_sample['y'] = factual_sample['y'] > 0.5
