...
def saveTreeVisualization(model, model_class, sub_model_name, X_test, feature_names, save_folder_name):
    save_path = '{save_folder_name}/{model_class}_{sub_model_name}_{c}_features'.format(save_folder_name=save_folder_name, model_class=model_class, sub_model_name=sub_model_name, c=X_test.shape[1])
