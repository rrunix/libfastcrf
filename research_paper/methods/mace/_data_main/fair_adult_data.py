...
import research_paper.methods.mace._data_main.fair_utils_data as ut
...
def check_data_file(file_name):
    ...
    print('Looking for file {file_name} in the {this_files_directory} directory..'.format(file_name=file_name, this_files_directory=this_files_directory))
